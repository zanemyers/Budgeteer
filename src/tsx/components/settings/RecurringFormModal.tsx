...
export function RecurringFormModal({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const url = isEdit
      ? `/budgets/${budgetPk}/recurring/${recurring!.id}/`
      : `/budgets/${budgetPk}/recurring/create/`;
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="py-4 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-2">
                <Label htmlFor="rt-category">Category <span className="text-destructive">*</span></Label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex flex-col gap-2 md:col-span-1">
                <Label htmlFor="rt-amount">Amount <span className="text-destructive">*</span></Label>
                <Input
                  id="rt-amount"
                  type="number"
                  step="0.01"
              ...
              <div className="flex flex-col gap-2 md:col-span-1">
                <Label htmlFor="rt-frequency">Frequency <span className="text-destructive">*</span></Label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                <Label htmlFor="rt-start">Start Date <span className="text-destructive">*</span></Label>
                <Input
                  id="rt-start"
                  type="date"
                  value={startDate}
            ...
            <div className="flex flex-col gap-2">
              ...
              <Select value={paymentMethod || "none"} onValueChange={(v) => setPaymentMethod(v === "none" ? "" : v)}>
                <SelectTrigger id="rt-pm" className="w-full"><SelectValue /></SelectTrigger>
                <SelectContent>
