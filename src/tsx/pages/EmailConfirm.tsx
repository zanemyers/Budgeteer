...
export default function EmailConfirm({ email, invalid }: Props) {
    ...
    return (
      <div className="card shadow-sm">
        <div className="card-body p-4 text-center">
          <h1 className="h5 fw-semibold mb-2">Invalid confirmation link</h1>
          <p className="text-muted small mb-4">This link is invalid or has already been used.</p>
    ...
    return (
      <div className="card shadow-sm">
        <div className="card-body p-4 text-center">
          ...
          <h1 className="h5 fw-semibold mb-2">Email confirmed</h1>
          <p className="text-muted small mb-4">{email} has been verified.</p>
  ...
  return (
    <div className="card shadow-sm">
      <div className="card-body p-4 text-center">
        <h1 className="h5 fw-semibold mb-2">Confirm your email</h1>
